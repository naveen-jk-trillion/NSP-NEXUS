...
// Correct Icon typing for Lucide
  ...
  return (
    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white border-gray-200">
      ...
      <CardContent className="text-center">
        ...
        <a href="https://forms.gle/UxcDoGwhGShCzCfs7" target="_blank" rel="noopener noreferrer">
...
export default function InternshipsPage() {
  const internships: InternshipCardProps[] = [
    {
      icon: Brain,
      ...
      difficulty: "Beginner",
      description:
        "Dive deep into AI algorithms, neural networks, and machine learning models. Build intelligent systems and explore the future of technology."
    },
    {
      icon: Database,
      ...
      difficulty: "Beginner",
      description:
        "Master ML algorithms, data preprocessing, and model optimization. Create predictive models and analyze complex datasets."
    },
    {
      icon: FileCode,
      title: "Data Science",
      ...
      difficulty: "Intermediate",
      description:
        "Extract insights from data using statistical analysis, visualization tools, and advanced analytics techniques."
    },
    {
      icon: Globe,
      ...
      difficulty: "Intermediate",
      description:
        "Build modern, responsive websites using HTML, CSS, JavaScript, and popular frameworks like React and Node.js."
    },
    {
      icon: Smartphone,
      ...
      difficulty: "Beginner",
      description:
        "Create native Android applications using Java/Kotlin, Android Studio, and modern development practices."
    },
    {
      icon: Palette,
      title: "UI/UX Design",
      ...
      difficulty: "Intermediate",
      description:
        "Design user-centered interfaces and experiences using Figma, Adobe XD, and design thinking methodologies."
    },
    {
      icon: Coffee,
      ...
      difficulty: "Beginner",
      description:
        "Learn object-oriented programming, data structures, and build robust applications with Java."
    },
    {
      icon: Code,
      ...
      difficulty: "Advanced",
      description:
        "Master Python fundamentals, libraries, and frameworks for web development, automation, and data analysis."
    },
    {
      icon: Cpu,
      title: "C++ Programming",
      ...
      difficulty: "Intermediate",
      description:
        "Deep dive into system programming, memory management, and high-performance computing with C++."
    },
    {
      icon: BarChart,
      ...
      difficulty: "Intermediate",
      description:
        "Create dashboards and reporting solutions using BI tools to drive data-informed decisions."
    },
    {
      icon: Boxes,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-primary via-purple-300 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Internship Opportunities</h1>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://forms.gle/CH2PN5fPPpSep36q7" target="_blank" rel="noopener noreferrer">
